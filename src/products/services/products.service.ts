...
export class ProductsService {
  ...
  defaultProducts() {
    const products = [
      ['7502241360163', 'VAPE INSECTICIDA', 120],
      ['7501059292406', 'SOBRE NESCAFE DOLCA DE 10 GR.', 24],
      ['7503013328053', 'ATRAPA MOSCAS CATCA MAX', 2],
      ['66674815019', 'ATRAPA MOSCAS TRAPAMEX', 2],
      ['7501059295193', 'NUTRI RINDES', 4],
      ['750105129923', 'SOPA INSTANTANEA KNORR FIDEOS', 1],
      ['750101835238', 'SOPA INSTANTANEA LA MODERNA ESTRELLA', 1],
      ['750108315092', 'SOPA INSTANTANEA LA MODERNA FIDEOS', 1],
      ['7501005190794', 'KNORR TOMATE 12 pz', 12],
      ['7506192502689', 'RICO POLLO', 20],
      ['750105199292', 'KNORR POLLO', 24],
      ['7506205815867', 'CHOCO MILK', 200],
      ['75058883', 'CERILLOS JAGUARES', 200],
      ['75036553', 'CERILLOS CLASICOS', 200],
      ['6973198989898', 'CUBRE BOCA', 200],
      ['750107341173', 'CHOCOLATE ABUELITA', 200],
      ['7501077400715', 'MASECA CHICA  570G', 5],
      ['750102606869', 'ROSA VENUS BLANCO', 2],
      ['7501026006661', 'ROSA VENUS ROSA', 3],
      ['752121291088', 'JABONCITO', 6],
      ['7506306245891', 'SAVILE', 1],
      ['7501026005688', 'ZOTE 200G ROSA', 2],
      ['7501026005381', 'ZOTE 200G BLANCO', 1],
      ['7501026005985', 'ZOTE 100G ROSA', 200],
      ['75025152032', 'JABON PRINCESA ROSA', 1],
      ['7502251522025', 'JABON PRINCESA AZUL', 200],
      ['7501077400050', 'Maseca 1KG', 9],
      ['7503015181274', 'Leche flor de Mexico', 10],
      ['604498702585', 'Leche vida blanca', 200],
      ['7502251520014', 'Harina sol de oro', 200],
      ['7509546682570', 'Suavitel lila', 200],
      ['7509546682594', 'Suavitel acqua', 200],
      ['7509546051932', 'Axion 750', 200],
      ['7501025403485', 'Pinol', 200],
      ['7501073411173', 'Chocolate abueoita', 200],
      ['011848455570', 'Achiote', 200],
      ['7501020566994', 'Yomi lala chocolate', 200],
      ['7501020567007', 'Yomi lala vainilla', 200],
      ['7501020567014', 'Yomi lala fresa', 200],
      ['011848245003', 'Vinagre Blanco', 200],
      ['7501003127235', 'Salsa casera', 200],
      ['7501008765012', 'Galletas cuétara chavalín', 20],
      ['7500478005857', 'Bizcochito gamesa', 20],
      ['7501144990019', 'Aceitunas en salmuera vermex', 200],
      ['7501144990132', 'Alcaparras en vinagre', 200],
      ['7501003150233', 'Mole doña maria', 200],
      ['7501008769010', 'Galleta cuétara diavolín', 20],
      ['7501058611062', 'Leche evaporada carnation', 200],
      ['7501017042937', 'Frijoles negros refritos  la costeña', 200],
      ...
      ['7501003100085', 'Mole doña maria 360g', 8],
      ...
      ['7501025403027', 'Pinol 500 ml', 20],
      ['7501030427018', 'Tortillas del hogar 10 p', 3],
      ['7501025400170', 'Pinol aromas 500ml', 20],
